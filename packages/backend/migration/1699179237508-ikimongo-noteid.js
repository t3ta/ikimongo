...
export class IkimongoNoteid1699179237508 {
	...
	async up(queryRunner) {
		...
		await queryRunner.query(
			`ALTER TABLE "observation" DROP CONSTRAINT "FK_7d06f253e52808a06cde80d013b"`,
		);
		await queryRunner.query(
			`ALTER TABLE "observation" ALTER COLUMN "noteId" SET NOT NULL`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "observation" ADD CONSTRAINT "FK_7d06f253e52808a06cde80d013b" FOREIGN KEY ("noteId") REFERENCES "note"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
		);
	}
	...
	async down(queryRunner) {
		...
		await queryRunner.query(
			`ALTER TABLE "observation" ALTER COLUMN "noteId" DROP NOT NULL`,
		);
		await queryRunner.query(
			`ALTER TABLE "observation" ADD CONSTRAINT "FK_7d06f253e52808a06cde80d013b" FOREIGN KEY ("noteId") REFERENCES "note"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
		);

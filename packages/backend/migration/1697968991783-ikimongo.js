...
export class Ikimongo1697968991783 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "observation" ("id" character varying(32) NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE, "userId" character varying(32) NOT NULL, "userHost" character varying(128), "fileIds" character varying(32) array NOT NULL DEFAULT '{}', "attachedFileTypes" character varying(256) array NOT NULL DEFAULT '{}', "date" TIMESTAMP WITH TIME ZONE, "locationName" character varying(256), "location" point, "noteId" character varying(32), CONSTRAINT "REL_7d06f253e52808a06cde80d013" UNIQUE ("noteId"), CONSTRAINT "PK_77a736edc631a400b788ce302cb" PRIMARY KEY ("id")); COMMENT ON COLUMN "observation"."createdAt" IS 'The created date of the Observation.'; COMMENT ON COLUMN "observation"."updatedAt" IS 'The updated date of the Observation.'; COMMENT ON COLUMN "observation"."userId" IS 'The owner Id.'; COMMENT ON COLUMN "observation"."userHost" IS 'The host of owner. It will be null if the user in local.'; COMMENT ON COLUMN "observation"."date" IS 'The updated date of the Observation.'; COMMENT ON COLUMN "observation"."locationName" IS 'The location name of the Observation.'; COMMENT ON COLUMN "observation"."location" IS 'The location of the Observation.'`);

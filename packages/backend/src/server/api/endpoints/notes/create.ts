    ...
    super(meta, paramDef, async (ps, me) => {
      ...
      const note = await this.noteCreateService.create(me, {
        ...
        observation: ps.observation
          ? {
              date: new Date(ps.observation.date!),
              decimalLatitude: ps.observation.decimalLatitude!,
              decimalLongitude: ps.observation.decimalLongitude!,
            }
          : undefined,
        identification: ps.identification
          ? {
              ...
              taxonId: ps.identification.taxonId,
              kingdom: ps.identification.kingdom,
              phylum: ps.identification.phylum,
              class: ps.identification.class,
              order: ps.identification.order,
              family: ps.identification.family,
              genus: ps.identification.genus,
              language: ps.identification.language,
              description: ps.identification.description,
            }
          : undefined,

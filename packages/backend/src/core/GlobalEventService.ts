...
export class GlobalEventService {
	...
	@bindThis
	public publishMainStream<K extends keyof MainEventTypes>(
		userId: MiUser["id"],
		type: K,
	...
	@bindThis
	public publishDriveStream<K extends keyof DriveEventTypes>(
		userId: MiUser["id"],
		type: K,
	...
	@bindThis
	public publishNoteStream<K extends keyof NoteEventTypes>(
		noteId: MiNote["id"],
		type: K,
	...
	@bindThis
	public publishUserListStream<K extends keyof UserListEventTypes>(
	...
	@bindThis
	public publishAntennaStream<K extends keyof AntennaEventTypes>(
	...
	@bindThis
	public publishRoleTimelineStream<K extends keyof RoleTimelineEventTypes>(
		roleId: MiRole["id"],
		type: K,
	...
	@bindThis
	public publishAdminStream<K extends keyof AdminEventTypes>(
		userId: MiUser["id"],
		type: K,

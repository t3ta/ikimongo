...
<template>
	...
	>
		<TransitionGroup
			:duration="
				(defaultStore.state.animation && props.transition?.duration) ||
				undefined
			"
			:enterActiveClass="
				(defaultStore.state.animation && props.transition?.enterActiveClass) ||
				undefined
			"
			:leaveActiveClass="
			...
			"
			:enterFromClass="
				(defaultStore.state.animation && props.transition?.enterFromClass) ||
				undefined
			"
			:leaveToClass="
				(defaultStore.state.animation && props.transition?.leaveToClass) ||
				undefined
			"
			:enterToClass="
				(defaultStore.state.animation && props.transition?.enterToClass) ||
				undefined
			"
			:leaveFromClass="
				(defaultStore.state.animation && props.transition?.leaveFromClass) ||
				undefined
			"
		>
			<canvas

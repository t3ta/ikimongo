		...
		<article v-else :class="$style.article" @contextmenu.stop="onContextmenu">
			...
			<div :class="$style.main">
				...
				<IGObservation
					...
					:location="appearNote.observation.location"
					:date="appearNote.observation.date"
				/>
				<MkInstanceTicker
					v-if="showTicker"
...
import { computed, inject, onMounted, ref, shallowRef, Ref } from "vue";
import * as mfm from "mfm-js";
import * as Misskey from "misskey-js";
import MkNoteSub from "@/components/mk_components/MkNoteSub.vue";
import MkNoteHeader from "@/components/mk_components/MkNoteHeader.vue";
...
import MkCwButton from "@/components/mk_components/MkCwButton.vue";
import MkPoll from "@/components/mk_components/MkPoll.vue";
import MkUsersTooltip from "@/components/mk_components/MkUsersTooltip.vue";
	...
	items = items.concat([
		{
			...
			action: () => {
				...
				const configuredVisibility = defaultStore.state.rememberNoteVisibility
...
function showRenoteMenu(viaKeyboard = false): void {
	...
	if (isMyRenote) {
		pleaseLogin();
		os.popupMenu(
			[getCopyNoteLinkMenu(note, i18n.ts.copyLinkRenote), null, getUnrenote()],
			renoteTime.value,
			{

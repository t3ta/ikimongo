...
import MkPostFormDialog from "@/components/mk_components/MkPostFormDialog.vue";
import MkWaitingDialog from "@/components/mk_components/MkWaitingDialog.vue";
import MkPageWindow from "@/components/mk_components/MkPageWindow.vue";
import MkToast from "@/components/mk_components/MkToast.vue";
import MkDialog from "@/components/mk_components/MkDialog.vue";
import MkPasswordDialog from "@/components/mk_components/MkPasswordDialog.vue";
import MkEmojiPickerDialog from "@/components/mk_components/MkEmojiPickerDialog.vue";
import MkEmojiPickerWindow from "@/components/mk_components/MkEmojiPickerWindow.vue";
import MkPopupMenu from "@/components/mk_components/MkPopupMenu.vue";
import MkContextMenu from "@/components/mk_components/MkContextMenu.vue";
	...
	return new Promise((resolve) => {
		popup(
			defineAsyncComponent(
				() => import("@/components/mk_components/MkFormDialog.vue"),
			),
			{ title, form },
			{
				done: (result) => {
...
export async function selectUser(opts: { includeSelf?: boolean } = {}) {
	return new Promise((resolve) => {
		popup(
			defineAsyncComponent(
				() => import("@/components/mk_components/MkUserSelectDialog.vue"),
			),
			{
...
export async function selectDriveFile(
	...
	return new Promise((resolve) => {
		popup(
			defineAsyncComponent(
				() => import("@/components/mk_components/MkDriveSelectDialog.vue"),
			),
			{
				type: "file",
				multiple,
...
export async function cropImage(
	...
	return new Promise((resolve) => {
		popup(
			defineAsyncComponent(
				() => import("@/components/mk_components/MkCropperDialog.vue"),
			),
			{
				file: image,

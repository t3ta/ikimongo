		...
		<MkSpacer :contentMax="600" :marginMin="16" :marginMax="32">
			...
			-->
					...
					<FormSection>
						<div class="_gaps">
							...
							<MkFolder>
								...
								<div class="_gaps">
									<div
										v-for="policy in Object.keys(info.policies)"
										:key="policy"
									>
				...
				<div v-else-if="tab === 'roles'" class="_gaps">
					<MkButton v-if="user.host == null" primary rounded @click="assignRole"
					...
					>
						<div :class="$style.roleItemMain">
							...
							<button
								class="_button"
								:class="$style.roleToggle"
								@click="toggleRoleItem(role)"
							>
						...
						>
							<div>
								...
								<MkTime
									:time="
										info.roleAssigns.find((a) => a.roleId === role.id).createdAt
									"
									mode="detail"
								/>
							</div>
				...
				<div v-else-if="tab === 'announcements'" class="_gaps">
					<MkButton primary rounded @click="createAnnouncement"
						><i class="ti ti-plus"></i> {{ i18n.ts.new }}</MkButton
					>
...
import MkChart from "@/components/mk_components/MkChart.vue";
import MkObjectView from "@/components/mk_components/MkObjectView.vue";
...
import MkFileListForAdmin from "@/components/mk_components/MkFileListForAdmin.vue";
...
import MkRolePreview from "@/components/mk_components/MkRolePreview.vue";
import MkPagination, {
	Paging,
...
function createAnnouncement() {
	os.popup(
		defineAsyncComponent(
			() =>
				import("@/components/mk_components/MkUserAnnouncementEditDialog.vue"),
		),
		{
			user,
		},

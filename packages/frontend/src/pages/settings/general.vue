		...
		<FormSection>
			<div class="_gaps_s">
				...
				<MkFolder>
					...
					<MkButton
						v-if="defaultStore.reactiveState.pinnedUserLists.value.length === 0"
						@click="setPinnedList()"
			...
			<div class="_gaps_m">
				<MkRadios v-model="notificationPosition">
					...
					<option value="leftTop">
						<i class="ti ti-align-box-left-top"></i> {{ i18n.ts.leftTop }}
					</option>
					<option value="rightTop">
						<i class="ti ti-align-box-right-top"></i> {{ i18n.ts.rightTop }}
					</option>
				...
				<MkRadios v-model="notificationStackAxis">
					...
					<option value="vertical">
						<i class="ti ti-carousel-vertical"></i> {{ i18n.ts.vertical }}
					</option>
		...
		<FormSection>
			...
			<div class="_gaps_m">
				<div class="_gaps_s">
					...
					<MkSwitch v-model="enableDataSaverMode">{{
						i18n.ts.dataSaver
					}}</MkSwitch>
				</div>
				<div>
			...
			<div class="_gaps">
				<MkFolder>
					...
					<div v-for="lang in emojiIndexLangs" class="_buttons">
						<MkButton @click="downloadEmojiIndex(lang)"
							><i class="ti ti-download"></i> {{ lang
							}}{{
								defaultStore.reactiveState.additionalUnicodeEmojiIndexes.value[
									lang
								]
									? ` (${i18n.ts.installed})`
									: ""
...
import MkLink from "@/components/mk_components/MkLink.vue";
...
const reactionsDisplaySize = computed(
	defaultStore.makeGetterSetter("reactionsDisplaySize"),
);
...
const highlightSensitiveMedia = computed(
	defaultStore.makeGetterSetter("highlightSensitiveMedia"),
);

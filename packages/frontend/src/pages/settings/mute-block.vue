					...
					<div class="_gaps_s">
						<div
							...
							:class="[
								$style.userItem,
								{
									[$style.userItemOpend]: expandedRenoteMuteItems.includes(
										item.id,
									),
								},
							]"
						>
							<div :class="$style.userItemMain">
								...
								>
									<i :class="$style.chevron" class="ti ti-chevron-down"></i>
								</button>
								<button
									class="_button"
									:class="$style.remove"
							...
							>
								<div>
									Muted at: <MkTime :time="item.createdAt" mode="detail" />
								</div>
							</div>
						</div>
					</div>
				...
				<template #default="{ items }">
					<div class="_gaps_s">
						<div
							...
							:class="[
								$style.userItem,
								{ [$style.userItemOpend]: expandedMuteItems.includes(item.id) },
							]"
						>
							<div :class="$style.userItemMain">
								<MkA
					...
					<div class="_gaps_s">
						<div
							...
							:class="[
								$style.userItem,
								{
									[$style.userItemOpend]: expandedBlockItems.includes(item.id),
								},
							]"
						>
							<div :class="$style.userItemMain">
							...
							>
								<div>
									Blocked at: <MkTime :time="item.createdAt" mode="detail" />
								</div>
								<div v-if="item.expiresAt">
									Period: {{ new Date(item.expiresAt).toLocaleString() }}
								</div>

	...
	<MkStickyContainer>
		...
		<MkSpacer :contentMax="700" :class="$style.main">
			<div v-if="channel && tab === 'overview'" class="_gaps">
				<div class="_panel" :class="$style.bannerContainer">
					...
					>
						...
						<div v-if="channel.isSensitive" :class="$style.sensitiveIndicator">
							{{ i18n.ts.sensitive }}
						</div>
			...
			<div v-if="channel && tab === 'timeline'" class="_gaps">
				...
				<MkPostForm
					v-if="
						$i && defaultStore.reactiveState.showFixedPostFormInChannel.value
					"
					:channel="channel"
...
import XChannelFollowButton from "@/components/mk_components/MkChannelFollowButton.vue";

		...
		<div class="main">
			<div v-if="!root" class="header">
				<div v-if="narrow === false" class="wide">
					<MkA to="/" class="link" activeClass="active"
						><i class="ti ti-home icon"></i> {{ i18n.ts.home }}</MkA
					>
					<MkA
						...
						class="link"
						activeClass="active"
						><i class="ti ti-message icon"></i> {{ i18n.ts.timeline }}</MkA
					>
					<MkA to="/explore" class="link" activeClass="active"
						><i class="ti ti-hash icon"></i> {{ i18n.ts.explore }}</MkA
					>
					<MkA to="/channels" class="link" activeClass="active"
						><i class="ti ti-device-tv icon"></i> {{ i18n.ts.channel }}</MkA
					>
				</div>
		...
		<Transition :name="'tray'">
			<div v-if="showMenu" class="menu">
				...
				<MkA to="/explore" class="link" activeClass="active"
					><i class="ti ti-hash icon"></i>{{ i18n.ts.explore }}</MkA
				>
				<MkA to="/announcements" class="link" activeClass="active"
					><i class="ti ti-speakerphone icon"></i
				...
				<MkA to="/pages" class="link" activeClass="active"
					><i class="ti ti-news icon"></i>{{ i18n.ts.pages }}</MkA
				>
				<MkA to="/play" class="link" activeClass="active"
					><i class="ti ti-player-play icon"></i>Play</MkA
				>
				<MkA to="/gallery" class="link" activeClass="active"
					><i class="ti ti-icons icon"></i>{{ i18n.ts.gallery }}</MkA
				>
				<div class="action">
...
import XSigninDialog from "@/components/mk_components/MkSigninDialog.vue";
import XSignupDialog from "@/components/mk_components/MkSignupDialog.vue";
